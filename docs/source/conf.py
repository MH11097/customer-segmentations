...
# customer_segmentations documentation build
...
from customer_segmentations import __version__ as release

# -- Project information -----------------------------------------------------

project = "customer_segmentations"
author = "Kedro"
...
htmlhelp_basename = "customer_segmentationsdoc"
...
latex_documents = [
    (
        master_doc,
        "customer_segmentations.tex",
        "customer_segmentations Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "customer_segmentations",
        "Project customer_segmentations codebase.",
        "Data-Science",
    )
]
